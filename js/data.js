...
const COMPONENTS = [
  ...
  },
  {
    ...
    categoryLabel: "Development Board",
    icon: "🟩",
    image: "image/ESP32-DevBoard.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 190,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Development Board",
    icon: "🟧",
    image: "image/NodeMCU-DevKit.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 190,
    project: "ECE Department Inventory",
...

  {
    ...
    icon: "💨",
    image: "image/MQ2-Gas-Sensor-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 50,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🌱",
    image: "image/Soil-Moisture-Sensor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 25,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🔊",
    image: "image/Ultrasonic-Sensor.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 40,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "☀️",
    image: "image/LDR-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 10,
    permPrice: 15,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🌡️",
    image: "image/DHT11-Sensor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 40,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🌧️",
    image: "image/Rain-Sensor-Module.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 15,
    permPrice: 25,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🔄",
    image: "image/MPU6050-IMU-Sensor.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 100,
    project: "ECE Department Inventory",
...

  {
    ...
    icon: "⚡",
    image: "image/Single-Channel-Relay-Module.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 10,
    permPrice: 25,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Relay & Switching",
    icon: "⚡⚡",
    image: "image/Two-Channel-Relay-Module.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 40,
    project: "ECE Department Inventory",
...

  {
    ...
    icon: "⚙️",
    image: "image/DC-Motor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 5,
    permPrice: 10,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Motors",
    icon: "🔩",
    image: "image/SG90-Servo-Motor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 50,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Motors",
    icon: "🎛️",
    image: "image/L293D-Motor-Driver.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 65,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Communication",
    icon: "📟",
    image: "image/RC522-RFID-Module-Pinout.png",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 175,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Communication",
    icon: "📱",
    image: "image/SIM800L-GSM-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 350,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Communication",
    icon: "🗺️",
    image: "image/NEO6M-GPS-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 150,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Power",
    icon: "🔋",
    image: "image/DC-DC-Voltage-Booster-Module.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 35,
  ...
  },
  {
    ...
    categoryLabel: "Prototyping",
    icon: "〰️",
    image: "image/Jumper-Wire-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 1,
    permPrice: 1.5,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Power",
    icon: "🔋",
    image: "image/Li-Ion_18650_Battery.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 40,
  ...
  },
  {
    ...
    categoryLabel: "Motors & Drivers",
    icon: "🌀",
    image: "image/DC-Fan-Motor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 45,
...
},
{
    ...
    categoryLabel: "Power",
    icon: "⚡",
    image: "image/Transformer-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 30,
    permPrice: 90,
