...
const COMPONENTS = [
...

  {
    ...
    icon: "🖥️",
    image: "https://upload.wikimedia.org/wikipedia/commons/a/a7/Lcd_nokia_3310.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 90,
    project: "ECE Department Inventory",
...

  {
    ...
    icon: "💨",
    image: "https://components101.com/sites/default/files/component_pin/MQ2-Gas-Sensor-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 50,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🌱",
    image: "https://components101.com/sites/default/files/component_pin/Soil-Moisture-Sensor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 25,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "☀️",
    image: "https://components101.com/sites/default/files/component_pin/LDR-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 10,
    permPrice: 15,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Sensor",
    icon: "🌡️",
    image: "https://components101.com/sites/default/files/component_pin/DHT11-Sensor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 40,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Relay & Switching",
    icon: "🔌",
    image: "https://components101.com/sites/default/files/component_pin/4-Channel-Relay-Module-Pinout.png",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 75,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Motors",
    icon: "🔩",
    image: "https://components101.com/sites/default/files/component_pin/SG90-Servo-Motor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 50,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Communication",
    icon: "📟",
    image: "https://components101.com/sites/default/files/component_pin/RC522-RFID-Module-Pinout.png",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 175,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Communication",
    icon: "📱",
    image: "https://components101.com/sites/default/files/component_pin/SIM800L-GSM-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 350,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Communication",
    icon: "🗺️",
    image: "https://components101.com/sites/default/files/component_pin/NEO6M-GPS-Module-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 150,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Power",
    icon: "☀️",
    image: "https://upload.wikimedia.org/wikipedia/commons/b/b7/Solar_panels_on_a_house_roof.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 15,
    permPrice: 25,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Prototyping",
    icon: "〰️",
    image: "https://components101.com/sites/default/files/component_pin/Jumper-Wire-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 1,
    permPrice: 1.5,
    project: "ECE Department Inventory",
  ...
  },
  {
    ...
    categoryLabel: "Power",
    icon: "🔋",
    image: "https://upload.wikimedia.org/wikipedia/commons/8/8b/Li-Ion_18650_Battery.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 40,
  ...
  },
  {
    ...
    categoryLabel: "Motors & Drivers",
    icon: "🌀",
    image: "https://components101.com/sites/default/files/component_pin/DC-Fan-Motor-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 20,
    permPrice: 45,
...
},
{
    ...
    categoryLabel: "Power",
    icon: "🔋",
    image: "https://components101.com/sites/default/files/component_pin/18650-Battery-Holder-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 2,
    permPrice: 5,
...
},
{
    ...
    categoryLabel: "Power",
    icon: "⚡",
    image: "https://components101.com/sites/default/files/component_pin/LM2596-Buck-Converter-Pinout.jpg",
    type: ["temporary", "permanent"],
    tempPrice: 30,
    permPrice: 90,
